...
for(const required of ['app_scope_hash','subject_hash','token_fingerprint','idempotency_key_hash','external_identity_bindings','admin_action_authorizations','entitlementRecheckRequired'])if(!sql.includes(required))issues.push(`012 缺少 ${required}`);
