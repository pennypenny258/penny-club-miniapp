...
- 四个移动优先底部入口：动态、活动、Agents、我的
- 动态与活动共用公开搜索词；活动页展示线上/线下主题、时间、地点、分享者/参会者与受控会议或归档入口
- 会员端第一版不展示研究报告、群聊精华、书籍和常用文件，知识库继续沿用飞书；后台资料治理能力保留
- Agents 只保留一个需求提交窗口，收集“我是谁、背景、具体需求”，支持公开或私密匹配两种前台选择
- 从电脑多文件导入资料的首选流程：白名单、私有保存、六分栏、待审核、下载开关与无文件条目
