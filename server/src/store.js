...
const activities = [
  {id:'a-online-open',format:'online',category:'topic_discussion',title:'智能制造的新机会（演示）',startsAt:days(7),endsAt:days(7.1),registrationEndsAt:days(6),meetingLinkOpensAt:days(6.9),meetingLinkClosesAt:days(7.1),status:'registration_open',speakers:[{name:'演示嘉宾·云岫',role:'产业研究者'}],attendeeSummary:'已报名 64 人（演示）',capacity:120,registeredCount:64,waitlistCount:0,archiveResourceIds:[]},
  {id:'a-offline-full',format:'offline',category:'city_salon',city:'示例城·东岸',venue:'东岸创投会客厅（虚构地点）',title:'产业协同案例拆解（演示）',startsAt:days(14),endsAt:days(14.2),registrationEndsAt:days(10),status:'waitlist_open',speakers:[{name:'演示嘉宾·远山',role:'产业合作负责人'}],attendeeSummary:'24 人确认，7 人候补（演示）',capacity:24,registeredCount:24,waitlistCount:7,archiveResourceIds:[]},
  {id:'a-hybrid-live',format:'hybrid',category:'topic_discussion',city:'示例城·南港',venue:'南港创新中心（虚构地点）',title:'早期产品验证工作坊（演示）',startsAt:days(-0.03),endsAt:days(0.15),registrationEndsAt:days(-1),meetingLinkOpensAt:days(-0.1),meetingLinkClosesAt:days(0.15),status:'in_progress',speakers:[{name:'演示嘉宾·知微',role:'产品顾问'}],attendeeSummary:'71 人确认，3 人候补（演示）',capacity:80,registeredCount:71,waitlistCount:3,archiveResourceIds:[]},
  {id:'a-ended',format:'online',category:'topic_discussion',title:'投研工具实践（演示）',startsAt:days(-21),endsAt:days(-20.9),registrationEndsAt:days(-22),meetingLinkOpensAt:days(-21.1),meetingLinkClosesAt:days(-20.9),status:'ended',speakers:[{name:'演示嘉宾·青禾',role:'投研工具实践者'}],attendeeSummary:'86 人参加（演示）',capacity:100,registeredCount:86,waitlistCount:0,archiveResourceIds:['r-demo-6']},
  {id:'a-cancelled',format:'offline',category:'city_salon',city:'示例城·西岭',venue:'西岭交流空间（虚构地点）',title:'新能源生态交流（已取消演示）',startsAt:days(20),endsAt:days(20.2),registrationEndsAt:days(18),status:'cancelled',speakers:[{name:'演示嘉宾·松风',role:'产业观察者'}],attendeeSummary:'原计划 30 人（演示）',capacity:30,registeredCount:12,waitlistCount:0,cancellationReasonCode:'venue_unavailable',archiveResourceIds:[]},
  {id:'a-annual',format:'offline',category:'annual_gathering',city:'示例城·北屿',venue:'北屿会议中心（虚构地点）',title:'会员年度聚会（演示）',startsAt:days(100),endsAt:days(100.35),registrationEndsAt:days(90),status:'draft',speakers:[],attendeeSummary:'参会者信息待公布',capacity:160,registeredCount:0,waitlistCount:0,archiveResourceIds:[]}
];
