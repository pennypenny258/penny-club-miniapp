...
const PRODUCTION_BOOTSTRAP_FORBIDDEN_VALUES = Object.freeze([
  ...
  'CRM_MATCH_TOKEN_ACTIVE_KEY_VERSION','CRM_MATCH_TOKEN_PREVIOUS_KEY_VERSION',
  'CRM_MATCH_TOKEN_MIGRATION_APPLIED',
  'CLOUDBASE_MEMBER_BINDING_RPC_MIGRATION_APPLIED',
  'CLOUDBASE_CRM_MATCH_TOKEN_TRANSPORT','CLOUDBASE_CRM_MATCH_TOKEN_CAPABILITY_SHA256',
  'CLOUDBASE_AGENT_RPC_CAPABILITY_VERSION','CLOUDBASE_AGENT_RPC_MANIFEST_SHA256',
...
function validateDeploymentEnvironment(environment = process.env) {
  ...
  if (environment.CLOUDBASE_CRM_MATCH_TOKEN_WRITES_ENABLED && environment.CLOUDBASE_CRM_MATCH_TOKEN_WRITES_ENABLED !== 'false') forbidden.push('CLOUDBASE_CRM_MATCH_TOKEN_WRITES_ENABLED');
  if (environment.CLOUDBASE_AGENT_RPC_ENABLED && environment.CLOUDBASE_AGENT_RPC_ENABLED !== 'false') forbidden.push('CLOUDBASE_AGENT_RPC_ENABLED');
